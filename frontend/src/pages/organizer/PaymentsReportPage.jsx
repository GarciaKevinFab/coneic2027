            ...
            <div className="card p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-display font-bold text-gray-900">{totalCount}</p>
                </div>
              </div>
            </div>
            <div className="card p-5">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-accent-50 flex items-center justify-center">
                  <HiCurrencyDollar className="w-5 h-5 text-accent-600" />
                </div>
                <div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      ...
                      <th className="text-left px-4 py-3 font-semibold text-gray-600">Metodo</th>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {payments.map((payment, idx) => {
                      const MethodIcon = methodIcons[payment.method] || HiCreditCard;
                      return (
                        <tr key={payment.id || idx} className="hover:bg-gray-50 transition-colors">
                          <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                            {payment.participant_name || payment.email || '--'}
                          </td>
